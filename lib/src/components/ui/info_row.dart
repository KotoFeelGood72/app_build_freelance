...
class InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Border border = Border(
      top: hasTopBorder ? BorderSide(width: 1, color: AppColors.border) : BorderSide.none,
      bottom: hasBottomBorder ? BorderSide(width: 1, color: AppColors.border) : BorderSide.none,
    );
