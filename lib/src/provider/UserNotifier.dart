...
import 'package:app_build_freelance/src/models/UserModel.dart';
...
class UserNotifier extends StateNotifier<UserState> {
  ...
  UserNotifier() : _dio = DioConfig().dio, super(UserState());
  ...
  Future<void> loadUser() async {
    ...
    try {
      ...
      if (e.response != null) {
        print('[DioError] Ответ сервера: ${e.response?.statusCode}, ${e.response?.data}');
      }
